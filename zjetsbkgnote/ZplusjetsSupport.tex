...
\addbibresource{ZplusjetsSupport.bib}
\addbibresource{bibtex/bib/atlas-paper.bib}

% Paths for figures - do not forget the / at the end of the directory name
\graphicspath{{logos/}{figures/}}

% Add you own definitions here (file SupportNote-defs.sty)
\usepackage{ZplusjetsSupport-defs}
...
\input{ZplusjetsSupport-metadata}
...
%\bibliography{SupportNote,bibtex/bib/atlas-paper}
%-------------------------------------------------------------------------------
